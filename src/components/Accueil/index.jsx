    ...
    return (
        <main className="accueil">
            <nav className="introduction">
                ...
                <p>
                    Découvrez un espace dédié à la lecture, à la connaissance et au partage du savoir.
                    Que vous soyez étudiant, chercheur ou passionné de littérature,
                    notre bibliothèque vous offre un large choix de livres,
                ...
                <FontAwesomeIcon icon={faBuildingColumns} style={{ color: "#400101" }} />
            </nav>
            <nav className="pic">
